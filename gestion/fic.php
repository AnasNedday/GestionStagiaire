...
/*body {
 ...
 <?php
if ( ! empty( $_COOKIE['f'] ) ) {                /*on va récupérer la valeur dans le cookie */ 
	
	$_SESSION['cine']=$_COOKIE['f'];
    $cine=$_SESSION['cine'];
    echo $cine; }
	
	$query =
	"SELECT * FROM offre,etudiant,document,demande where etudiant.cine=demande.cine and 
				demande.ide=offre.id and etudiant.cine=document.cine  and demande.cine='$cine'";
